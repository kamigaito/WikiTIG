...
path=${ROOT}/models/bart_base/title-to-table/10_1e-4_0.2/checkpoint_best.pt
result_path=${ROOT}/results/bart_base/title-to-table-for-image-gen
...
data_dir=${ROOT}/../datasets/text-to-text/exact/title-to-table

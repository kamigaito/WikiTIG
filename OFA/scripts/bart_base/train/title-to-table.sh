...
cd ${ROOT}/OFA/run_scripts/gigaword
...
input_model_file=${ROOT}/checkpoints/ofa_base.pt
weight_model_file=${ROOT}/checkpoints/bart.base/model.pt
restore_file=${ROOT}/checkpoints/bart.base/ofa_model.pt

python ${ROOT}/scripts/utils/inherit_params.py \
    --input ${input_model_file} \
    --weight ${weight_model_file} \
    --output ${restore_file}

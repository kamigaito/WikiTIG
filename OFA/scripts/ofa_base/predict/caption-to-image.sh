...
data=${ROOT}/../datasets/text-to-image/256/exact/caption-to-image/test.tsv
selected_cols=0,2,1
split='test'
...
for seed in {0,1,2,}; do
  ...
  path=${ROOT}/models/ofa_base/caption-to-image/40000_2000_1e-3_${seed}/checkpoint_best.pt
  GEN_IMAGE_PATH=${ROOT}/results/ofa_base/caption-to-image/${seed}/test

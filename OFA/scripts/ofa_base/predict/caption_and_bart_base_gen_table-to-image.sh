...
for seed in {0,1,2,}; do
  ...
  data=${ROOT}/results/bart_base/title-to-table/${seed}/test_predict_for_image_gen.tsv
  
  # Preprocess
  python ${ROOT}/scripts/utils/pipeline-for-image-gen.py \
    ${ROOT}/results/bart_base/title-to-table/${seed}/test_predict.json \
  ...
  GEN_IMAGE_PATH=${ROOT}/results/ofa_base/caption_and_bart_base_gen_table-to-image/${seed}/test

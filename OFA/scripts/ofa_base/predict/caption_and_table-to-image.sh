...
data=${ROOT}/../datasets/text-to-image/256/exact/caption_and_table-to-image/test.tsv
selected_cols=0,2,1
split='test'
...
for seed in {0,1,2,}; do
  ...
  GEN_IMAGE_PATH=${ROOT}/results/ofa_base/caption_and_table-to-image/${seed}/test

...
log_dir=${ROOT}/logs/base/image-to-title
save_dir=${ROOT}/models/base/image-to-title
...
data_dir=${ROOT}/../datasets/image-to-text/480/ease/image-to-title
  ...
  for warmup_ratio in {0.06,}; do
    ...
    for drop_worst_after in {6000,}; do
      ...
      CUDA_VISIBLE_DEVICES=0,1,2,3 python3 -m torch.distributed.launch --nproc_per_node=4 --master_port=${MASTER_PORT} ../../train.py \
          ...
          --eval-args='{"beam":5,"max_len_b":1024,"no_repeat_ngram_size":3}' \

...
data_dir=${ROOT}/../datasets/text-to-image/256/exact/caption-to-image
...
log_dir=${ROOT}/logs/ofa_base/caption-to-image
save_dir=${ROOT}/models/ofa_base/caption-to-image
  ...
  for warmup_updates in {2000,}; do
    ...
    for lr in {1e-3,}; do
      ...
      for seed in {0,1,2,}; do
        ...
        GEN_IMAGES_PATH=${ROOT}/results/ofa_base/caption-to-image/${seed}/valid

...
ROOT=${PWD}
OUTPUT=${ROOT}/results/ofa_base/image-to-table/eval.csv
...
for seed in {0,1,2,}; do
  ...
  python ${ROOT}/scripts/utils/image2para.py \
    ${ROOT}/../datasets/image-to-text/480/ease/image-to-table/test.tsv \
    ${ROOT}/results/ofa_base/image-to-table/${seed}/test_predict.json \
    ${ROOT}/results/ofa_base/image-to-table/${seed}/test_predict.converted.json
